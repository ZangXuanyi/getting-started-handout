...
对于计算机新手，我们推荐使用Windows和macOS系统作为操作系统，这是因为它们提供了友好的用户界面和丰富的软件支持，适合初学者使用。对于希望深入学习计算机的初学同学，我们推荐使用Linux系统的发行版Ubuntu、Mint、Manjaro，因为它具有和Windows与macOS类似的图形界面。对于希望进阶的同学，我们推荐使用Arch、Nix、Gentoo，它们是轻量级的Linux发行版，具有高度的可定制性和灵活性。
...
\begin{itemize}
  ...
  \item 输入类
    \begin{itemize}
      ...
      \item ContextMenuManager：可视化的右键菜单管理器，通过图形界面操作注册表来编辑和管理右键菜单，避免菜单栏过长。
  ...
  \item 效率与自动化
    \begin{itemize}
      ...
      \item AutoHotkey：一个强大的自动化脚本工具，可以很方便地完成热键修改、文本替换、自定义宏等操作。
  ...
  \item 其他
    \begin{itemize}
      ...
      \item Ventoy：一个开源的u盘启动工具，能够使多个ISO镜像共存于U盘，而不必将单一镜像烧录于U盘。它能使多个镜像文件和U盘其他文件共存，是装机盘和资料盘合一的好工具。
      ...
      \item Okular：一个免费的开源PDF阅读器，支持多种文档格式，包括PDF、EPUB等。较Foxit更为轻量。
