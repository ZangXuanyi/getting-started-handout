...
%---------- 页面与字体 ----------
\setmainfont{Noto Serif CJK SC}[AutoFakeSlant]
\setsansfont{Noto Sans CJK SC}[Scale=MatchLowercase,AutoFakeSlant]
\setmonofont{Noto Sans Mono CJK SC}[Scale=MatchLowercase,AutoFakeSlant]
\setCJKmainfont[ItalicFont = FZKai-Z03,ItalicFeatures = {AutoFakeSlant = false},BoldItalicFont = FZKai-Z03,BoldItalicFeatures = {AutoFakeSlant = false,AutoFakeBold = true}]{Noto Serif CJK SC}
...
\newtcolorbox{reading}[1][]{enhanced,colback=purple!4!white,colframe=purple!65!black,coltitle=white,fonttitle=\bfseries,title={\IfBlankTF{#1}{阅读材料}{阅读材料：#1}},top=2mm,bottom=2mm,left=2.5mm,right=2.5mm,boxrule=0.6pt,breakable,fontupper=\small,before upper={\setlength{\parindent}{2em}}}
