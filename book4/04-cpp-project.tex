\chapter{C系工程概述}\label{chap:cpp-project}
...
\section[C系包管理]{C系包管理\protect\footnote{本节作者臧炫懿，周乾康修改。}}
...
Conan是一个跨平台的C++包管理器，支持多种构建系统，包括CMake、Make等。Conan的使用方式也很简单：
\begin{minted}{bash}
...
\section[Meson]{Meson\protect\footnote{本章作者周乾康。}}\label{sec:meson}
